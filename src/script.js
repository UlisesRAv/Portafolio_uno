let playlist = [ {
  'title': 'Maquiavelíco - Muerte',
  'audio': "assets/Maquiavelico.mp3",
}, {
  'title': 'Ley del Hielo - Vida',
  'audio': "assets/LeyDelHielo.mp3",
}, {
  'title': 'De la Vida como Película - Sencillo',
  'audio': "assets/LaVidaComoPelicula.mp3",
}, {
  'title': 'Tripolar - Sencillo',
  'audio': "assets/Tripolar.mp3",
} ];
i = 0;
n = playlist.length;
